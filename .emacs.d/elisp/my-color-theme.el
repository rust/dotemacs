(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (jaspace-highlight-tab-face ((t (:background "unspecified-bg" :foreground "red" :strike-through nil :underline t))))
     ...
     (trailing-whitespace ((t (:background "unspecified-bg" :foreground "red" :strike-through nil :underline t))))
