(defun my-color-theme-window ()
  ...
  (color-theme-install
   '(my-color-theme-window
     ...
     (completions-common-part ((t (:stipple nil :background "black" :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 1 :width normal :family "default"))))
     ...
     (jaspace-highlight-tab-face ((t (:background "black" :foreground "red" :strike-through nil :underline t))))
     ...
     (nxml-outline-active-indicator-face ((t (:stipple nil :background "black" :foreground "unspecified-fg" :inverse-video nil :box 1 :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 1 :width normal :family "default"))))
     (nxml-outline-ellipsis-face ((t (:bold t :stipple nil :background "black" :foreground "unspecified-fg" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight bold :height 1 :width normal :family "default"))))
     (nxml-outline-indicator-face ((t (:stipple nil :background "black" :foreground "unspecified-fg" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 1 :width normal :family "default"))))
     ...
     (trailing-whitespace ((t (:background "black" :foreground "red" :strike-through nil :underline t))))
